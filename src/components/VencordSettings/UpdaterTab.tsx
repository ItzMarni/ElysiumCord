...
function Updater() {
    ...
    return (
        <SettingsTab title="Elysium Updater">
            <Forms.FormTitle tag="h5">Updater Settings</Forms.FormTitle>
            <Switch
                value={settings.autoUpdate}
                onChange={(v: boolean) => settings.autoUpdate = v}
                note="Automatically update Elysium without confirmation prompt"
            >
            ...
            <Switch
                ...
                note="Shows a notification when Elysium automatically updates"
